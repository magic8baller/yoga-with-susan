...
export default function Intro () {
  ...
  const data = useStaticQuery(graphql`
    query {
      file(relativePath: { eq: "cr0w_pose.jpg" }) {
        childImageSharp {
          fluid {
  ...
  return (
    <Container>
      ...
      <Photo
        ...
        alt='Susan Turis doing headstand'
        draggable={false}
      ...
      <Greeting isVisible={loaded}>
        <Title>NAMASTE, I'm Susan</Title>
        <Description>
          I’m an Iyengar yoga instructor from Brooklyn, NYC. I have a passion for teaching, studying philosophy and being in nature.
        </Description>
      </Greeting>
    </Container>
  )
